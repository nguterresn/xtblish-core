...
APP_0_OFFSET := 0x210000
APP_1_OFFSET := 0x410000
...
sign: zephyr
	python3 ../bootloader/mcuboot/scripts/imgtool.py sign --key $(SIGN_KEYS_PATH) --version $(IMAGE_0_VERSION) --align 4 --header-size 32 --slot-size $(IMAGE_0_SLOT_SIZE) build/zephyr/zephyr.bin dist/signed-image0.bin
...
flash-sign: sign
	python3 /Users/nunonogueira/Projectos/zephyr-projects/modules/hal/espressif/tools/esptool_py/esptool.py -p /dev/cu.wchusbserial58FC0505471 --baud 921600 --before default_reset --after hard_reset write_flash -u --flash_mode dio --flash_freq 40m --flash_size detect $(IMAGE_0_OFFSET) dist/signed-image0.bin
